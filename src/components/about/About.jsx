...
function About() {
    ...
    return (
        <div className="container" style={{ height: "80vh", color: "white" }}>
            ...
            <input type="text" value={search} onKeyDown={handleSearch} onChange={e => setSearch(e.target.value)} className="w-80 md:w-50 h-10 rounded-full bg-transparent border px-3 outline-none mt-3" placeholder="Search your README... (amir-alipour)" />
